...
export function TurborepoIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 318" {...props}>
      <defs>
        <linearGradient
          id="SVGrQHrus6t"
          x1="123.779%"
